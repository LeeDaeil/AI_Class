...
from Exam_Model_Tester import CNS_Platform_controller_interface as CNS_controller
from Exam_Model_Tester.main_win import MainWindow
...
class MyForm(QWidget):
    def __init__(self, shmem):
        ...
        # Call
        self.cns_main_win = MainWindow(parnet=self, mem=self.shmem)
