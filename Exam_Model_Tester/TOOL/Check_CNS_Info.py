...
def get_cns_info():
    ...
    if com_ip == '192.168.0.29':
        return {
            0: {'CNSIP': '192.168.0.101', 'COMIP': '192.168.0.29', 'PORT': 7105, 'PID': False},
        }
    else:
        # return {
        ...
        return {
            ...
            # 3: {'CNSIP': '192.168.0.212', 'COMIP': '192.168.0.200', 'PORT': 7201, 'PID': False},
            # 4: {'CNSIP': '192.168.0.212', 'COMIP': '192.168.0.200', 'PORT': 7202, 'PID': False},
            # 5: {'CNSIP': '192.168.0.212', 'COMIP': '192.168.0.200', 'PORT': 7203, 'PID': False},

            # 6: {'CNSIP': '192.168.0.213', 'COMIP': '192.168.0.200', 'PORT': 7301, 'PID': False},
            # 7: {'CNSIP': '192.168.0.213', 'COMIP': '192.168.0.200', 'PORT': 7302, 'PID': False},
            # 8: {'CNSIP': '192.168.0.213', 'COMIP': '192.168.0.200', 'PORT': 7303, 'PID': False},
        }


def get_abs_path():
    """
    현재 컴퓨터의 ip를 확인후 이에 따라 절대 경로 반환
    :return:
    """
    com_ip = socket.gethostbyname(socket.getfqdn())

    if com_ip == '192.168.0.29':
        return 'H:/Code/AI_Class/Exam_Model_Tester'
    else:
        return 'C:/Users/Com/Desktop/DL_Code/Soft_Actor_Critic_Agent_CNS'


def get_db_abs_path():
    """
    현재 컴퓨터의 ip를 확인후 이에 따라 DB의 절대 경로 설정
    :return:
    """
