...
import copy
#
from Exam_Model_Tester.ENVCNS import ENVCNS
from Exam_Model_Tester.AI_Module import AllAIModule
# AI Module
        ...
        while True:
            ...
            if local_logic['Run']:
                if local_logic['Run_ai']:
                    ...
                    model_outs = self.AI.predict(copy.deepcopy(self.cns_env.mem))
                    self.shmem.change_model_out(model_outs)
                    # end AI
                # One Step CNS -------------------------------------------------------------------------------------
                ...
                # 자동 멈춤 조건
                if self.cns_env.mem['KCNTOMS']['Val'] > 200:
